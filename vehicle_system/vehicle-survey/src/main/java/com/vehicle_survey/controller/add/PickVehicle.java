            ...
            try {
                ...
                for (FileItem fileItem : fileItemList) {
                    ...
                    if (fileItem.isFormField()) {
                        ...
                        if ("license".equals(fieldName)) license = fileItem.getString("utf-8");
                        else if ("manageNo".equals(fieldName)) manageNo = fileItem.getString("utf-8");
                        else if ("type".equals(fieldName)) type = Integer.valueOf(fileItem.getString("utf-8"));
                        else if ("peopleNum".equals(fieldName))
                            peopleNum = Integer.valueOf(fileItem.getString("utf-8"));
                        else if ("emission".equals(fieldName)) emission = fileItem.getString("utf-8");
                        else if ("price".equals(fieldName)) price = Double.valueOf(fileItem.getString("utf-8"));
                    }

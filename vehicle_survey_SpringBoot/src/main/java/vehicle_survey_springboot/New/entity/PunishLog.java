...
public class PunishLog {
    ...
    public PunishLog(Integer punishId, String surveyNo, String surveyName, String accidentMsg, Timestamp accidentTime, String accidentPoint, String punishMsg, Double punishAmount, Integer payStatus, String license) {
    ...
    public PunishLog(Integer punishId, String accidentMsg, Timestamp accidentTime, String accidentPoint, String punishMsg, Double punishAmount, Integer payStatus) {
        this.punishId = punishId;
        this.accidentMsg = accidentMsg;
        this.accidentTime = accidentTime;
        this.accidentPoint = accidentPoint;
